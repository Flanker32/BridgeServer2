...
public class UploadSchemaServiceTest {
    ...
    private void createV4TestHelper(int expectedRev, int inputRev, Integer oldRev) {
        ...
        // Validate we set key parameters when passing the schema to the DAO, including appId and rev.
    ...
    public void updateV4Success() {
        ...
        // Validate we set key parameters when passing the schema to the DAO, including appId, schema ID, and rev.
        UploadSchema daoInputSchema = daoInputSchemaCaptor.getValue();
        assertEquals(daoInputSchema.getAppId(), TEST_APP_ID);
