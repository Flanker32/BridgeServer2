...
public class CriteriaScheduleStrategyTest {
    ...
    public void validatesInvalidScheduleCriteria() {
        ...
        criteria.setNoneOfStudyIds(ImmutableSet.of("studyC", "studyD"));
        ...
        try {
            ...
            assertError(e, "strategy.scheduleCriteria[4].criteria.allOfStudyIds", 0, " 'studyC' is not in enumeration: <empty>");
            assertError(e, "strategy.scheduleCriteria[4].criteria.allOfStudyIds", 1, " includes these excluded studies: studyC");
            assertError(e, "strategy.scheduleCriteria[4].criteria.noneOfStudyIds", 0, " 'studyC' is not in enumeration: <empty>");
            assertError(e, "strategy.scheduleCriteria[4].criteria.noneOfStudyIds", 1, " 'studyD' is not in enumeration: <empty>");
            ...
            assertError(e, "strategy.scheduleCriteria[5].criteria.allOfStudyIds", 0, " 'studyC' is not in enumeration: <empty>");
            assertError(e, "strategy.scheduleCriteria[5].criteria.allOfStudyIds", 1, " includes these excluded studies: studyC");
            assertError(e, "strategy.scheduleCriteria[5].criteria.noneOfStudyIds", 0, " 'studyC' is not in enumeration: <empty>");
            assertError(e, "strategy.scheduleCriteria[5].criteria.noneOfStudyIds", 1, " 'studyD' is not in enumeration: <empty>");
         }
    }
    ...
    private void setUpStrategyWithRequiredAndProhibitedSets() {
        ...
        criteria.setAllOfStudyIds(TestConstants.USER_STUDY_IDS);
        criteria.setNoneOfStudyIds(ImmutableSet.of("studyC"));
        strategy.addCriteria(new ScheduleCriteria(SCHEDULE_FOR_STRATEGY_WITH_APP_VERSIONS, criteria));
    }
