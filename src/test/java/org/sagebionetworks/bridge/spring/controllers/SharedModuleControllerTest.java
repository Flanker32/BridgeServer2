...
public class SharedModuleControllerTest extends Mockito {
    ...
    public void byIdAndVersion() throws Exception {
        // mock service
        when(mockSvc.importModuleByIdAndVersion(TEST_APP_ID, MODULE_ID, MODULE_VERSION)).thenReturn(
    ...
    public void latestPublished() throws Exception {
        // mock service
        when(mockSvc.importModuleByIdLatestPublishedVersion(TEST_APP_ID, MODULE_ID)).thenReturn(
                new SharedModuleImportStatus(SCHEMA_ID, SCHEMA_REV));
